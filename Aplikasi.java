...
public class Aplikasi {
    ...
    private static void callFormUbahData() {
        scanner = new Scanner(System.in);
        String nomor, nama, jenis_kendaraan, warna;
        ...
        jenis_kendaraan = scanner.nextLine();
        System.out.print("WARNA : ");
        warna = scanner.nextLine();
        service.ubahData(new Kendaraan(nomor, nama, jenis_kendaraan, warna));
    }
    ...
    private static void callFormTambahData() {
        ...
        System.out.print("WARNA : ");
        warna = scanner.nextLine();
        service.tambahData(new Kendaraan(nomor, nama, jenis_kendaraan, warna));
    }
